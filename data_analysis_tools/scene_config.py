...
class SceneConfigLoader:
    ...
    def load_scene_config(file_path: str) -> tuple[str, List[str]]:
        ...
        try:
            ...
            logger.info(f"Successfully loaded scene config file: {file_path}")
            ...
            logger.info(f"Loaded scenario: {scenario}, {len(business_types)} business types from scene config")
